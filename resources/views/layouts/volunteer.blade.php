...
@section('navbar')
    {{-- <nav class="d-flex gap-4">
        <a href="{{ route('volunteer.events.index') }}">Events</a>
        <a href="{{ route('volunteer.organizations.index') }}">Organizations</a>
        <a href="{{ route('volunteer.participation.index') }}">Activity</a>
        <a href="{{ route('volunteer.leaderboard.index') }}">Leaderboard</a>
        <a href="{{ route('volunteer.profile.index') }}">Profile</a>
