    ...
    <nav class="shadow-lg sticky top-0 bg-white/70 backdrop-blur-md z-100">
        <div class="container mx-auto px-4 md:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-8">
                    <a href="{{ route('organization.events.index') }}"      class="text-[var(--color1)] hover:text-gray-300 text-base font-medium">Acara</a>
                    <a href="{{ route('organization.leaderboard.index') }}" class="text-[var(--color1)] hover:text-gray-300 text-base font-medium">Leaderboard</a>
                    <a href="{{ route('organization.news.index') }}"        class="text-[var(--color1)] hover:text-gray-300 text-base font-medium">Berita</a>
                </div>
        ...
        <div class="lg:hidden hidden" id="mobile-menu">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="{{ route('organization.events.index') }}"      class="text-[var(--color1)] block px-3 py-2 rounded-md text-base font-medium">Acara</a>
                <a href="{{ route('organization.leaderboard.index') }}" class="text-[var(--color1)] block px-3 py-2 rounded-md text-base font-medium">Leaderboard</a>
                <a href="{{ route('organization.news.index') }}"        class="text-[var(--color1)] block px-3 py-2 rounded-md text-base font-medium">Berita</a>
                <a href="{{ route('organization.profile.show') }}"      class="text-[var(--color1)] block px-3 py-2 rounded-md text-base font-medium">Profil Saya</a>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
