                ...
                <form action="{{ route('register') }}" method="post" class="space-y-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="inline-flex items-center text-sm text-gray-700">
                                <input type="radio" name="gender" value="male"
                                    class="form-radio text-[var(--color1)] h-4 w-4"
                    ...
                    <div class="flex items-center pt-1">
                        <input type="checkbox" name="terms" id="terms"
                            class="form-checkbox text-[var(--color1)] h-3.5 w-3.5" required>
                        <label for="terms" class="ml-1.5 text-sm text-gray-700">
                            Saya menyetujui <a href="#" class="text-[var(--color1)] hover:underline">syarat &
                                ketentuan</a>
                        </label>
                    </div>
                    @error('terms')
