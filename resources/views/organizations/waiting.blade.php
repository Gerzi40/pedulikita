...
<style>
    :root { --blue-1:#0546d6; --blue-2:#00b4ff; }
    * { box-sizing: border-box; }
    ...
    .wave.left { left:-260px; top:-240px; transform:rotate(20deg); }
    .wave.right { right:-260px; bottom:-240px; transform:rotate(-20deg); }

    .container { position:relative; z-index:1; width:920px; max-width:94%; display:flex; justify-content:center; padding:20px 0; }
    .card {
      width:820px;
      background: #e9e9ea;
      border-radius:12px;
  ...
  .monitor img {
    ...
    .progress-wrap { margin-top:14px; padding:6px 8px; }
    .progress {
      height:12px;
      background:#dfeffb;
      border-radius:999px;
    ...
    @keyframes progress-anim { from { transform: translateX(-2%);} to { transform: translateX(0%);} }

    .title { font-size:20px; font-weight:700; color:#111827; margin:14px 8px 6px 8px; }
    .note { color:#4b5563; font-size:14px; margin:0 8px 14px 8px; line-height:1.45; }

    @media (max-width:920px) {
      .monitor { height:240px; padding:12px; }
      .card { width:94%; }
    }
  </style>
